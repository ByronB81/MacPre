...
class PhoneBook
{
  ...
  static void AddContact()
  {
    ...
    Console.WriteLine("Enter the new contacts phone number");
    string number = Console.ReadLine();
    if (phoneNumbers.ContainsKey(name))
    {
      Console.WriteLine("That person already is already in the phone book. Their number is " + phoneNumbers[name]);
    }
    else
    {
